...
# Create the Python script in the user's home directory
cat > "$USER_HOME/orange.py" << 'EOF'
#!/usr/bin/env python3
import requests
import urllib3
...
PYTHON_SCRIPT="$HOME/orange.py"  # Path to the Python script in the user's home directory
...
# Install the requests package with --break-system-packages
